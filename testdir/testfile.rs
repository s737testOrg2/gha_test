33333444👜",👜",👜",👜", substrate/frame/bags-list/src/lib.rs:			concat!("[{:?}] 👜", $patter), <frame_system::Pallet<T>>::block_number() $(, $values)*
...
# x🔒substrate/client/cli/src/runner.rs🔒	info!("🏷 Node name: {}", config.network.node_name);k
